...
const Pagination = ({pages,setCurrentPage,currentEmployees,sorted}) => {
    const numOfPages = [];
    ...
    return (
        <div className="clearfix">
            <div className="hint-text">Showing <b>{currentEmployees.length}</b> out of <b>{sorted.length}</b> entries</div>
